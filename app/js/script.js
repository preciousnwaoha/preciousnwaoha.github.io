...
(() => {
  // Experience section
const servicesTimelineWrapper = document.querySelector("#services-items-wrapper")
...
(() => {
  const projectsItemsWrapper = document.querySelector("#projects-items-wrapper")
    ...
    .then(data => {
      ...
      for (let i = 0; i < projects.length; i++) {
        projectsItemsWrapper.innerHTML += `
          ...
          <div class="portfolio-item" data-category="${projects[i].categories.join(" ")}">
            <div class="portfolio-item-inner outer-shadow">
              <div class="portfolio-item-img">
                <img src="${projects[i].thumbnail}" alt="portfolio image" data-screenshots="${projects[i].imgs}">
                <!-- view project btn -->
                ...
                <div class="row">
                  ...
                  <div class="info">
                    ...
                    <ul>
                      ...
                      <li>Tools - <span>${projects[i].tools.join(", ")}</span></li>
                      <li>Github - <span><a href="${projects[i].github}">${projects[i].github}</a></span></li>
                      <li>Link - <span><a href="${projects[i].link}">${projects[i].link}</a></span></li>
                    </ul>
                  </div>
                </div>
              </div>
